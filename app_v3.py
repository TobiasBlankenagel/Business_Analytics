...
st.markdown("""
    ...
    text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.2);">🏟️ Stadium Attendance Prediction App</h1>
    <div style="text-align: center; padding: 20px; background-color: #f9f9f9; border-radius: 20px; 
    box-shadow: 0 6px 15px rgba(0, 0, 0, 0.15); margin-bottom: 30px;">
        <p style="font-size: 20px; color: #555555;">
            🎉⚽ This app predicts stadium attendance based on various factors such as the teams playing, weather conditions, and matchday info. Use the inputs below to get the prediction!
        </p>
    </div>
